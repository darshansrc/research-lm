...
export const metadata: Metadata = {
  ...
  description: 'ResearchLM: Your AI-powered research assistant for analyzing data, taking notes, and creating diagrams from various sources including CSV, PDF, and more.',
  keywords: ['research', 'AI', 'data analysis', 'note-taking', 'diagram creation', 'CSV', 'PDF'],
